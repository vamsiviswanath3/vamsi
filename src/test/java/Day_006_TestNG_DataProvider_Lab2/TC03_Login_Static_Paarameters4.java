...
public class TC03_Login_Static_Paarameters4 {
	...
	public void Login_Test(String TestURL,String UserName,String Password,String Nationality) throws Exception
	{
		...
		TC03_Login_Static_Paarameters4.OpenChromeBrowser();
		TC03_Login_Static_Paarameters4.OpenOrangeHRM(TestURL);
		TC03_Login_Static_Paarameters4.Login(UserName,Password);
		TC03_Login_Static_Paarameters4.AddNationalities(Nationality);
		driver.quit();
	}
